...
class PHPExcel_Writer_Excel2007_StringTable extends PHPExcel_Writer_Excel2007_WriterPart
{
     ...
     * @param     string[]                 $pExistingTable     Existing tables to eventually merge with
     * @return     string[]                 String tables for worksheet
     * @throws     PHPExcel_Writer_Exception
     */
    public function createStringTable($pSheet = null, $pExistingTable = null)
    {
        if ($pSheet !== null) {
            // Create string lookup tables
            $aStringTable = array();
            $cellCollection = null;
            $aFlippedStringTable = null;    // For faster lookup

            // Is an existing tables given?
    ...
    /**
     * Write string tables to XML format
     *
    ...
    public function writeStringTable($pStringTable = null)
    {
        if ($pStringTable !== null) {
            ...
            throw new PHPExcel_Writer_Exception("Invalid string tables array passed.");
        }
    }
...
//                    $objWriter->writeAttribute('xml:space', 'preserve');    //    Excel2010 accepts, Excel2007 complains
    ...
    /**
     * Flip string tables (for index searching)
     *
